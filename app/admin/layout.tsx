      ...
      <div className="bg-imperial-dark text-white border-b border-jkhub/20 py-2">
        <div className="container flex items-center justify-between">
          <div className="flex items-center gap-2">
            <Image
              src="/images/jk2-logo-new.png"
              alt="JK2 Logo"
              width={20}
              height={20}
              className="h-5 w-5"
            />
            <span className="font-bold text-jkhub text-glow-jkhub">
              JK2 Summer Tournament 2025 Admin
            </span>
          </div>
          <Link href="/">
            <Button
              variant="outline"
              size="sm"
              className="border-jkhub text-jkhub hover:bg-jkhub/10"
            >
              Back to Site
            </Button>
          </Link>
